...
import { RootState, MineState, ProfileState } from '@/store/reducers';
import Navbar from '@/components/NavBar';
import './index.less';
import { Form, Input, Button, message } from 'antd';
import actions from '@/store/actions/profile';
import { UserAddOutlined, LockOutlined, MailFilled, MailOutlined } from '@ant-design/icons';
import { LoginPayload } from '@/typing/user';
  ...
  return (
    <>
      ...
      >
        ...
        <Form.Item>
          <Button type="primary" htmlType='submit' className='register-form-submit'>登录</Button>
        </Form.Item>
      </Form>
    </>
  )
